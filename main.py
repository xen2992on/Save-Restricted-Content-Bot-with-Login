...
API_ID = int(os.getenv("27338814", "5120"))
API_HASH = os.getenv("0e1b690b05167770e33901a8fc865c37", "1fda88a5d1de478bce198e")
BOT_TOKEN = os.getenv("7353794578:AAHC6y4GY7Kc0ZoZTbOyyPlaMKPCEm_0b8Y", "token")
MONGODB_URL = os.getenv("mongodb+srv://zennie713:hindi2992@cluster0.uzztvri.mongodb.net", "mongouri")
BOT_USERNAME = None
